...
function renderChart(data, datasetName, params) {
  ...
  xAxisGroup.attr('transform', `translate(0,${graphViewProps.height - graphViewProps.margin_bottom})`).attr('class', 'xaxis').call(xAxis);
  yAxisGroup.attr('transform', `translate(${graphViewProps.margin_left}, 0)`).attr('class', 'yaxis').call(yAxis);

  xAxisLabelGroup.append('text')
    .attr('class', 'xlabel')
    .attr('text-anchor', 'middle')
    .attr('x', graphViewProps.width / 2)
    .attr('y', graphViewProps.height - 10)
  ...
  yAxisLabelGroup
    .attr('transform', `translate(20, ${graphViewProps.height / 2}) rotate(-90)`);
